...
import { capitalize, calculateCalories } from "./modules/helpers.js";
...
const API = new FetchWrapper(
  "https://firestore.googleapis.com/v1/projects/food-app-34ce2/databases/(default)/documents/gorky1985"
);
...
const render = () => {
  totalCal.textContent = appData.getTotalCalories();
};
